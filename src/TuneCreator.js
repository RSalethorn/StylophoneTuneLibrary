...
class TuneCreator extends React.Component {
    ...
    addNoteToSong(e) {
        ...
        setTimeout(function() { e.target.style.opacity = "0%"; }, 500);
    }
    ...
    selectBeat(e) {
        ...
        this.setState({selectedBeat: beatNo, startGroupSelectedBeat: null, endGroupSelectedBeat: null});
    }
    ...
    onGroupSelectStart(e) {
        ...
        this.setState({isGroupSelect: true, selectedBeat: null, startGroupSelectedBeat: startBeatNo, endGroupSelectedBeat: null});
    }
